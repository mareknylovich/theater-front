      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            ...
            <h6 style={{ color: '#000' }}>Basierend auf einem Roman in Versen von Alexander Puschkin</h6>
            <h6 style={{ color: '#000' }}>Tatianas Träume, 18+</h6>
            ...
            <div className="row">
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Regisseur</strong> — Roman Gabria
                    </p>
                    <p>
                      <strong>Inszenierung</strong> — Roman Gabria
                    </p>
                    <p>
                      <strong>Choreograph</strong> — Alexei Karpenko
                    </p>
                    <p>
                      <strong>Produktionsdesigner</strong> — Nikolai Slobodianik
                    </p>
                    <p>
                      <strong>Kostümbildnerin</strong> — Nina Sternberg
                    </p>
                    <p>
                      <strong>Lichtdesigner</strong> — Denis Solntsev
                    </p>
                    <p>
                      <strong>Komponist</strong> — Vladislav Krylov
                    </p>
                    <p>
                      <strong>Schriftsteller für Vokalmusik</strong> — Grigory Uglov
                    </p>
                    <p />{' '}
                  </div>
                </div>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>Eine der großen Liebesgeschichten wurde durch eine Reihe von Unfällen ausgelöst.</p>
                    <p>
                      Onegin, ein Salonlöwe und Ballbesucher, findet sich auf dem Lande wieder. Er trifft den
                      Dichter Lensky. Er betritt das Haus seiner Verlobten Olga. Ihre Schwester Tatjana
                      verliebte sich sofort in Onegin. Und&nbsp;er&nbsp;brach ihr&nbsp;das Herz. Lensky war
                      eifersüchtig auf seine Braut und seinen Freund. Er&nbsp;hat&nbsp;seine&nbsp;Meinung
                      nicht&nbsp;geändert. Lensky stirbt. Olga heiratet einen Lanzenreiter. Auch Tatiana wurde
                      gezwungen, sie zu retten. Sie hat die Welt erobert. Eine kurze zufällige Begegnung und
                      Onegin liegt Tatjana zu Füßen. Neben&nbsp;ihm stand ein weiterer Begleiter&nbsp;—
                      Chandra. Eine zerstörerische Kraft, die Onegin unterwarf, und&nbsp;dann alle, die
                      mit&nbsp;ihm verbunden waren.
                    </p>
                    <p>
                      Aber der Zuschauer des Stücks 'Onegin&nbsp;wird nicht zusammen mit den Figuren durch die
                      Gassen spazieren und den Verlauf einer bekannten Geschichte verfolgen. Der Regisseur
                      nimmt ihn an die Hand und führt ihn durch ein Labyrinth aus Träumen, Träumereien und
                      Erinnerungen an die Hauptfigur des Romans, Tatiana.
                    </p>
                    <p>
                      <strong>Vielen Dank für Ihre Unterstützung des Münchner Schauspielhauses. </strong>
                    </p>
                    <p>
                      Die Aufführung umfasst Vokalkompositionen: «Jungfrauen, Schönheiten», «Der Wind zieht
                      Wolken auf», «Ruhe, o Heiland» (Gebet), «Immer bescheiden».
                    </p>
                    <p />{' '}
                  </div>
                </div>
            ...
            <div className="row row-50">
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Ilja Borissow</span>
                  </h6>
                  <div className="unit-body">
                    <span>Wladimir Lenski</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Alexandra Magelatowa</span>
                  </h6>
                  <div className="unit-body">
                    <span>Tatjana Larina</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Der General, Tatjanas Ehemann</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Ilja Livschitz</span>
                  </h6>
                  <div className="unit-body">
                    <span>Ein Junge, der aussieht wie Puschkin</span>
                  </div>
                </article>
              </div>{' '}
            </div>
