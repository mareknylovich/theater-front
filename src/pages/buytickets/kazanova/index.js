      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            ...
            <h6 style={{ color: '#000' }}>Basierend auf den Arbeiten von Marina Tsvetaeva</h6>
            <h6 style={{ color: '#000' }}>Liebesgeschichte, 16+</h6>
              ...
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Produktion und Choreografie</strong> — Preisträger des Staatspreises der
                      Ukraine, Verdienter Kunstschaffender der Ukraine Sergey Gritsay
                    </p>
                    <p>
                      <strong>Szenografie</strong> — Emile Capelouche
                    </p>
                    <p>
                      <strong>Kostüme</strong> — Andrei Klimov
                    </p>
                    <p>
                      <strong>Lichtdesigner</strong> — Denis Solntsev
                    </p>
                    <p>
                      <strong>Musikalischer Leiter</strong> — Sergey Patramansky
                    </p>
                    <p />{' '}
                  </div>
                </div>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      Die Abenteuer des berühmten Venezianers, des legendären Verführers Casanova, sind in
                      aller Munde. Sein Leben ist voll von Intrigen und schwindelerregenden Romanzen. Doch
                      selbst unzählige Liebhaber können sein Herz nicht verdrängen, ein einziger, wirklich
                      geliebter, begehrter, aber unerbittlicher Wille des Schicksals geht verloren.&nbsp;
                    </p>
                    <p>
                      Die Schöpfer der Inszenierung wollen mit Hilfe von Bühnenbildern und Kostümen, die von
                      einem Team hochkarätiger Spezialisten erarbeitet werden, ganz in die Pracht und den
                      Luxus des venezianischen Karnevals des 18. Jahrhunderts eintauchen: Künstler,
                      historische Berater, Juweliere, Spitzenschneiderinnen, Kopfbedeckungen, Masken und
                      Schuhe. Für jedes Kostüm werden mehr als 15 Stoffarten benötigt, von denen die meisten
                      von italienischen Designern entworfen werden. Vintage-Broschen und authentische
                      venezianische Masken vervollständigen den Look.&nbsp;
                    </p>
                    <p>
                      Das Leben und die Leidenschaft des großen Verführers, erzählt in der eleganten
                      poetischen Sprache von Marina Zwetajewa, entfaltet sich auf der Bühne des Vartanyan
                      Drama Theaters, inszeniert und choreographiert von einem der berühmtesten plastischen
                      Regisseure des Landes, Sergei Gritsai.&nbsp;
                    </p>
                    <p />{' '}
                  </div>
                </div>
                ...
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      ...
                      <p></p>
                      <p>3 Stunden 10 Minuten mit einer Unterbrechung</p>
                      <p />
                    </div>
                  </div>
                </article>
            ...
            <div className="row row-50">
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Mimi, französische Besucherin, Köchin, Näherin</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Francisca, polnischer Besucher, Bote</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Prince de Ligne, Le Duc (Casanovas Diener), Buckliger</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Französischer Botschafter, Hauptmann, alter Kammerdiener</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Spanische Botschafterin, Mutter Venedig, Butler</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Sandro, Eros, Viderol (Dichter)</span>
                  </div>
                </article>
              </div>{' '}
            </div>
