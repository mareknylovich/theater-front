      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            ...
            <h6 style={{ color: '#000' }}>Basierend auf William Shakespeares König Lear</h6>
            <h6 style={{ color: '#000' }}>Tragikomödie, 18+</h6>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      Konstantin Bogomolov hat William Shakespeares berühmte Tragödie «König
                      Lear&nbsp;in&nbsp;eine schwarze Komödie verwandelt, indem er in&nbsp;einer Aufführung
                      das scheinbar&nbsp;Unzusammenhängende miteinander verbindet. Der neue
                      Lear&nbsp;&nbsp;—ist eine Kombination aus extremem Spektakel, gemischt
                      mit&nbsp;aggressiver Theatralik und&nbsp;witzigem, groteskem Schauspiel, mit&nbsp;Gags
                      und&nbsp;Nervenkitzel, mit&nbsp;Reflexionen über&nbsp;die&amp; moderne&amp; Welt
                      und&nbsp;den&amp; Platz&amp; des&nbsp;Menschen in&amp; dieser&amp; Welt.
                    </p>
                    <p>
                      Diese fesselnde Geschichte in einer &nbsp;provokativen Ästhetik,&nbsp;—ironisch
                      &nbsp;tragisch, knallhart &nbsp;lyrisch zugleich... «In&nbsp;deine Augen sah
                      ich&nbsp;kürzlich, O&nbsp;Leben: das Gold in&nbsp;der Nacht deine Augen&nbsp;—
                      leuchteten, und&nbsp;mein Herz wurde ohnmächtig vor leidenschaftlichem Verlangen.... Wer
                      hasste dich&nbsp;&nbsp;—fesselnd, verstrickend, verführend, suchend, findend! Wer hat
                      dich nicht&nbsp;geliebt&nbsp;—der unschuldige, ungeduldige, flüchtige Sünder
                      mit&nbsp;Kinderaugen! ...Dann schaute sich das Leben nachdenklich um und&nbsp;sagte
                      leise: „O&nbsp;Mann, du&nbsp;bist mir nicht&nbsp;zu treu!
                      Du&nbsp;hast&nbsp;mich&nbsp;nicht so sehr geliebt, wie du sagst; ich&nbsp;weiß, dass
                      du&nbsp;mich“bald verlassen wirst. Und&nbsp;wir&nbsp;sahen&nbsp;einander an,
                      und&nbsp;blickten&nbsp;auf&nbsp;die grüne Wiese; auf&nbsp;die die Abendkühle sank,
                      und&nbsp;weinten. Und&nbsp;damals&nbsp;war mir das Leben lieber als je meine ganze
                      Weisheit».
                    </p>
                    ...
                    <h6>Feste</h6>
                    <ul className="list-marked">
                      <li>Teilnehmerin am Programm Ukraine Case beim Festival «Golden Mask 2012;</li>
                      <li>
                        Teilnehmerin am Festival für zeitgenössisches Theater «Theaterformen» (Hannover,
                        Deutschland) 2013&nbsp;Jahr;
                      </li>
                      <li>Teilnehmerin des Internationalen Theaterkunstforums «Teart» (Minsk, Belarus);</li>
                      <li>Teilnehmer an der Theatersaison in Marseille», 2013.</li>
                    </ul>
                    <p />{' '}
                  </div>
                </div>
                ...
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      ...
                      <p></p>
                      <p>2 Stunden 30 Minuten mit einer Unterbrechung</p>
                      <p />
                    </div>
                  </div>
                </article>
            ...
            <div className="row row-50">
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Gonerilla Lirovna Albani, seine Frau</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Semyon Mikhailovich Cornwell, General der Armee / Dr. Luntz</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Anton Moschtschkow</span>
                  </h6>
                  <div className="unit-body">
                    <span>Regan Lirovna Cornwell, seine Frau</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Pawel Tschinarew</span>
                  </h6>
                  <div className="unit-body">
                    <span>Cordelia Lear, Lears jüngste Tochter</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Tatjana Bondarewa</span>
                  </h6>
                  <div className="unit-body">
                    <span>
                      Herr Zarathustra, europäischer Botschafter auf unserer Seite / Prophet Zarathustra,
                      psychiatrischer Sonderpatient
                    </span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Alexandra Winogradowa</span>
                  </h6>
                  <div className="unit-body">
                    <span>Samuel Yakovlevich Gloucester, Schriftsteller</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Aljona Bondartschuk</span>
                  </h6>
                  <div className="unit-body">
                    <span>Edgar Samuelovich Gloucester, sein legitimer Sohn, ein Jude</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>
                      Edmond Samuilovich Gloucester, sein unehelicher Sohn, Russe (mütterlicherseits)
                    </span>
                  </div>
                </article>
              </div>{' '}
