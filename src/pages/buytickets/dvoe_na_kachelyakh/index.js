      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            <h1 style={{ color: '#000' }}>Zwei auf einer Schaukel</h1>
            <h6 style={{ color: '#000' }}>William Gibson</h6>
            <h6 style={{ color: '#000' }}>lyrisches Drama, 16+</h6>
            ...
            <div className="row">
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Aufführung</strong>&nbsp;— Verdienter Kunstschaffender der Ukraine, Träger des
                      Stanislawski-Preises. K.&nbsp;S.&nbsp;Stanislavsky Veniamin Filshtinsky
                    </p>
                    <p>
                      <strong>Szenografie</strong>&nbsp;— Vladimir Firer, Verdienter Künstler der Ukraine
                    </p>
                    <p>
                      <strong>Choreographie</strong>&nbsp;— Sergey Gritsay, Verdienter Kunstschaffender der
                      Ukraine, Preisträger des russischen Staatspreises
                    </p>
                    <p>
                      <strong>Kostüme</strong>&nbsp;— Angelika Verkeenko
                    </p>
                    <p>
                      <strong>Lichtdesigner&nbsp;</strong>— Gleb Filshtinsky, Gewinner des
                      Nationaltheaterpreises «Goldene Maske
                    </p>
                    <p>
                      <strong>Musikdesign</strong>&nbsp;— Wladimir Bytschkowski
                    </p>
                    <p>
                      <strong>Assistentin für die Ausbildung von Schauspielern&nbsp;</strong>— Larissa
                      Gracheva
                    </p>
                    <p />{' '}
                  </div>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <h6>DAS STÜCK WURDE ÜBER 150 MAL GESPIELT!</h6>
                    <p>
                      Die&nbsp;Bühne«Drama Theatre»&nbsp;—legendäre Broadway-Melodrama. Werden die geschiedene
                      Tänzerin und der von seiner Frau verlassene Anwalt ihr lang ersehntes gemeinsames Glück
                      finden können? Können sie die richtige Entscheidung treffen, wenn ihre unglückliche
                      Liebe zu der einen Frau und seine Zärtlichkeit und Fürsorge für die andere Frau in ihren
                      Herzen auf Kriegsfuß stehen? Ihre Beziehung ist nicht einfach, aber ihr neu entdeckter
                      Sinn für das Leben ermöglicht es ihnen, ihre Beziehung wiederherzustellen. Sie werden
                      ihr Leben überdenken müssen, um eine Antwort zu finden.
                    </p>
                    <p>
                      Der renommierte Regisseur Veniamin Filshtinsky hebt das Stück in mythologische Höhen und
                      reimt es auf die Liebesgeschichte von Didon und Aeneas.
                    </p>
                    <h5>Auszeichnungen</h5>
                    <ul className="list-marked">
                      <li>
                        Die Produktion&nbsp;—— Gewinner des &amp;lquo;Golden Sofit» High Theatre Award
                        für&nbsp;«Best Ensemble»&nbsp;— Elena Kalinina und&nbsp;Dmitry Vorobiev (2005).
                      </li>
                      <li>Die Produktion nahm an der Prager Theatersaison 2007 teil.</li>
                    </ul>
                    <h5>Die Fakten</h5>
                    <ul className="list-marked">
                      <li>
                        Bis 2013 wurde die Rolle des Geri von Dmitry Vorobiev gespielt, bis 2019 von Oleg
                        Fedorov.
                      </li>
                      <li>
                        Die Produktion&nbsp;—basiert auf dem legendären Broadway-Stück. Die New Yorker
                        Premiere hatte mehr als 750 (!) Aufführungen mit dem gut aussehenden Hollywoodstar
                        Henry Fonda und der schwülen Anne Bancroft in den Hauptrollen.
                      </li>
                    </ul>
                    <p />{' '}
                  </div>
                ...
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      ...
                      <p></p>
                      <p>2 Stunden und 40 Minuten mit einer Unterbrechung</p>
                      <p />
                    </div>
                  </div>
                </article>
