      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            <h1 style={{ color: '#000' }}>Diese losen Schmetterlinge</h1>
            <h6 style={{ color: '#000' }}>Leonard Gersh</h6>
            <h6 style={{ color: '#000' }}>Schmierenkomödie, 16+</h6>
            ...
            <div className="slick-gallery">
              ...
              >
                <div className="item">
                  <img src="/storage/images/qWct7KL1t1g47yhRJOaqyNOoFCVuYmRt3Vgw.jpeg" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Direktor der Kamera</strong>&nbsp;— Waleri Filonow
                    </p>
                    <p>
                      <strong>Produktionsdesigner</strong>&nbsp;— Natalia Osipowa
                    </p>
                    <p>
                      <strong>Komponist</strong>&nbsp;— Arthur Gorbenko
                    </p>
                    <p />{' '}
                  </div>
                </div>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      Die Liebesgeschichte eines jungen Mannes aus einer wohlhabenden Familie und eines
                      flatterhaften, extravaganten Mädchens, das davon träumt, Schauspielerin zu
                      werden,&nbsp;— eine sentimentale Geschichte des modernen Lebens, eine berühmte
                      Broadway-Komödie voller lebendiger Reprisen und Dialoge, dargeboten von Meistern der
                      Bühne. Das Leben ist nicht vorbei, wenn das Mädchen, das man liebt, weg ist...
                    </p>
                    <p>&nbsp;</p>
                    <p>Die 500. Vorstellung wurde am 27. Dezember 2014 gespielt.</p>
                    <p>Die 600. Vorstellung wurde am 14. August 2017 gespielt.&nbsp;</p>
                    <p>
                      <strong>Die 650. Vorstellung wurde am 2. November 2019 gespielt.</strong>
                    </p>
                    <p />{' '}
                  </div>
                </div>
                ...
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      ...
                      <p></p>
                      <p>2 Stunden 45 Minuten mit einer Unterbrechung</p>
                      <p />
                    </div>
                  </div>
                </article>
                  ...
                  <div className="blurb-circle__icon">
                    <span className="text-center">
                      <a
                        ...
                        data-actorid={1}
                        style={{
                          backgroundImage: 'url("/storage/images/rn5GWtszypqMp2yaKQ5iHnK6l2lyYANmp16K.png")',
                        }}
                      ></a>
                    </span>
                  </div>
                  <h6 style={{ color: '#000' }}>
                    <span>Alexander Glebow</span>
                  </h6>
                  <div className="unit-body">
                  ...
                  <div className="blurb-circle__icon">
                    <span className="text-center">
                      <a
                        ...
                        data-actorid={1}
                        style={{
                          backgroundImage: 'url("/storage/images/LFYkBM72kp55HRPHGkagvFdvf6ANpxalg4GG.png")',
                        }}
                      ></a>
                    </span>
                  </div>
                  <h6 style={{ color: '#000' }}>
                    <span>Galina Mochalowa</span>
                  </h6>
                  <div className="unit-body">
                    <span>Fräulein Baker</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                  ...
                  <div className="blurb-circle__icon">
                    <span className="text-center">
                      <a
                        ...
                        data-actorid={1}
                        style={{
                          backgroundImage: 'url("/storage/images/S9ArUxRTIOgSbdCOoUro8YRNTr2oC4sBc830.png")',
                        }}
                      ></a>
                    </span>
                  </div>
                  <h6 style={{ color: '#000' }}>
                    <span>Wurzeln Lekus</span>
                  </h6>
                  <div className="unit-body">
                    <span>Ralph Austin</span>
                  </div>
                </article>
              </div>{' '}
            </div>
            ...
            <div className="row no-gutters">
              <div className="col-md-3">
                <a
                  ...
                  href="/storage/images/2MWhnJSGoSrudTc71PZ8dzfYUomI0QkPzmnH.jpeg"
                  style={{ background: 'url("/storage/images/2MWhnJSGoSrudTc71PZ8dzfYUomI0QkPzmnH.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/2MWhnJSGoSrudTc71PZ8dzfYUomI0QkPzmnH.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/DCex54AGQcYquWGNLacTyxys6lVFWS3lrlqn.jpeg"
                  style={{ background: 'url("/storage/images/DCex54AGQcYquWGNLacTyxys6lVFWS3lrlqn.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/DCex54AGQcYquWGNLacTyxys6lVFWS3lrlqn.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/af7dysXjy6WzmdEoHpcPRnPLk08eOnmv2KDU.jpeg"
                  style={{ background: 'url("/storage/images/af7dysXjy6WzmdEoHpcPRnPLk08eOnmv2KDU.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/af7dysXjy6WzmdEoHpcPRnPLk08eOnmv2KDU.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/LVloB3UXVugfBwIiH9pUVnEnp9v8cxQMMBDc.jpeg"
                  style={{ background: 'url("/storage/images/LVloB3UXVugfBwIiH9pUVnEnp9v8cxQMMBDc.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/LVloB3UXVugfBwIiH9pUVnEnp9v8cxQMMBDc.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/lswpmW0wPM4HDsSqWXuH9OouaootMR9R5biM.jpeg"
                  style={{ background: 'url("/storage/images/lswpmW0wPM4HDsSqWXuH9OouaootMR9R5biM.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/lswpmW0wPM4HDsSqWXuH9OouaootMR9R5biM.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/ELUtGTwERyu2d0g1cmQqo6UHieMw9vJrdCno.jpeg"
                  style={{ background: 'url("/storage/images/ELUtGTwERyu2d0g1cmQqo6UHieMw9vJrdCno.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/ELUtGTwERyu2d0g1cmQqo6UHieMw9vJrdCno.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/0QqktZE48eWkj7IypCQVhZzaGnazZbMyuc7U.jpeg"
                  style={{ background: 'url("/storage/images/0QqktZE48eWkj7IypCQVhZzaGnazZbMyuc7U.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/0QqktZE48eWkj7IypCQVhZzaGnazZbMyuc7U.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/tL46VPmIZQW04p80UHAV3N5taB2ZWpBHxrIH.jpeg"
                  style={{ background: 'url("/storage/images/tL46VPmIZQW04p80UHAV3N5taB2ZWpBHxrIH.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/tL46VPmIZQW04p80UHAV3N5taB2ZWpBHxrIH.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/mXKPtdIc9UHhDKzwDZ7jwXjk1wGZDYvWoxLo.jpeg"
                  style={{ background: 'url("/storage/images/mXKPtdIc9UHhDKzwDZ7jwXjk1wGZDYvWoxLo.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/mXKPtdIc9UHhDKzwDZ7jwXjk1wGZDYvWoxLo.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/8mHpks5APs0Wfd43vec5JmX8OZ2dCXSG5Otj.jpeg"
                  style={{ background: 'url("/storage/images/8mHpks5APs0Wfd43vec5JmX8OZ2dCXSG5Otj.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/8mHpks5APs0Wfd43vec5JmX8OZ2dCXSG5Otj.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/Rmd278JujyRVi5Sfu57NtKgoQJjbJa00kqNm.jpeg"
                  style={{ background: 'url("/storage/images/Rmd278JujyRVi5Sfu57NtKgoQJjbJa00kqNm.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/Rmd278JujyRVi5Sfu57NtKgoQJjbJa00kqNm.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
              ...
              <div className="col-md-3">
                <a
                  className="thumb-modern bg-img"
                  data-lightgallery="item"
                  href="/storage/images/LAFIT42vbUrftmZw9lQgjHNAPrtzo5pwiG9q.jpeg"
                  style={{ background: 'url("/storage/images/LAFIT42vbUrftmZw9lQgjHNAPrtzo5pwiG9q.jpeg")' }}
                >
                  <figure style={{ display: 'none' }}>
                    <img
                      src="/storage/images/LAFIT42vbUrftmZw9lQgjHNAPrtzo5pwiG9q.jpeg"
                      alt=""
                      width={418}
                      height={315}
                    />
