      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            ...
            <h6 style={{ color: '#000' }}>fantastische Tragikomödie, 16+</h6>
            ...
            <div className="row">
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Übersetzung aus dem Spanischen</strong> — Vladimir Podguskov
                    </p>
                    <p>
                      <strong>Regisseur</strong> — Yavor Gardev (Bulgarien)
                    </p>
                    <p>
                      <strong>Künstler</strong> — Gewinnerin des Höchsten Theaterpreises «Golden Sofit» Maria
                      Lucca und Gewinner des Theaterpreises für Jugendliche «Durchbruch» Alexander Mokhov
                    </p>
                    <p>
                      <strong>Lichtdesigner</strong> — Verdienter Kulturschaffender Russlands, Yevgeny
                      Ganzburg
                    </p>
                    <p>
                      <strong>Komponist</strong> — Kalin Nikolov (Bulgarien)
                    </p>
                    <p />{' '}
                  </div>
                </div>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <h5>Erstaufführung des Stücks in Deutschland!</h5>
                    <p>
                      Mexikanischer Ferienort Cancun. Als Reme eines unglücklichen Morgens aufwacht, stellt
                      sie überrascht fest, dass ihr Mann sie nicht als seine Frau und seine Kinder nicht als
                      ihre Mutter anerkennt. Es ist ein grausamer Scherz, ein Fleck von der hellen Sonne oder
                      etwas Ernsteres: ein von Albert Einstein inspirierter Scherz, eine Verschiebung von Zeit
                      und Raum, die die Figuren in eine andere Realität versetzt hat...
                    </p>
                    <p>
                      Die erste deutsche Inszenierung des Stücks des zeitgenössischen spanischen Dramatikers
                      Jordi Galseran. Er ist in ganz Europa für seine Theaterstücke, Drehbücher und
                      literarischen Übersetzungen ins Spanische und Katalanische bekannt (er übersetzte unter
                      anderem Gogols Generalinspektor). Zu Galserans beliebtesten Stücken zählen «Words on a
                      Chain», «Dakota», «Gaudi», «Grönholm Method», «Carnival», «Burundanga». 2010 erblickte
                      seine Dramaturgie zum ersten Mal das Licht der ukrainischen Bühne: Am Kiewer Theater der
                      Nationen wurde "Die Grönholm-Methode" des bulgarischen Regisseurs Yavor Gardev
                      inszeniert. Das gleiche internationale Tandem trat auch bei «Cancun» auf: der Dramatiker
                      Galseran und der Regisseur Girdev.
                    </p>
                    <p>
                      Die erste Inszenierung fand im Oktober 2008 im Teatro Enrique Borras in Barcelona statt.
                      Die erste Aufführung des Stücks in der Ukraine fand am 11. Mai 2012 auf der Bühne des
                      Vartanian Drama Theatre statt..
                    </p>
                    <blockquote>
                      <h6>Über den Regisseur</h6> Yavor Girdev wurde 1972 in Sofia geboren. Er absolvierte die
                      Philosophische Fakultät der Kliment-Ohridski-Universität in Sofia und anschließend die
                      K. Sarafov-Akademie für Theater- und Filmkunst als Theaterregisseur. Yavor Girdevs
                      Lehrer war der berühmte Ivan Dobchev, Mitbegründer des Theaterlabors «sfumato», eines
                      Zentrums der bulgarischen Theateravantgarde, der sich mit Videokunst beschäftigte und
                      Autor mehrerer Kunstperformances war.
                    </blockquote>
                    <p />{' '}
                  </div>
                </div>
              ...
              <div className="col-md-6">
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      <p className="blurb__title heading-6">Продолжительность</p>
                      <p></p>
