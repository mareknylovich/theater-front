      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            <h1 style={{ color: '#000' }}>Faryatievs Phantasien</h1>
            <h6 style={{ color: '#000' }}>Alla Sokolowa</h6>
            <h6 style={{ color: '#000' }}>Tragikomödie, 16+</h6>
              ...
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Unter der Regie von</strong> — Natalia Lapina
                    </p>
                    <p>
                      <strong>Szenografie und Kostüme</strong> — Mykola Slobodyanik
                    </p>
                    <p>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      Die Menschen strecken unaufhörlich die Hand aus, aber sie können nie zueinander finden
                      und ihr Glück finden...
                    </p>
                    <p>
                      Paul und Alexandra treffen sich zufällig auf einer Party von Freunden. Diese netten
                      Sonderlinge, die träumen und lieben können, scheinen dazu bestimmt zu sein, zusammen zu
                      sein. Die Verbindung hätte alle glücklich gemacht: Sascha hätte einen einfühlsamen
                      Ehemann gefunden, ihre Mutter — einen Schwiegersohn, ihre jüngere Schwester — einen
                      Freund.
                    </p>
                    <p>
                      Aber Liebe und Harmonie sind immer nur einen Schritt entfernt. Und die Leben der Figuren
                      sind wie Radiowellen, die auf verschiedenen Frequenzen auseinanderfliegen und nie
                      zusammenkommen können.
                    </p>
                    <blockquote>
                      <strong>Regisseurin Natalia Lapina über das Stück:</strong> «Diese Geschichte hat einen
                      zeitlosen Plot, so dass sie ihre Zeit überdauert zu haben scheint. Wir haben die Epoche
                      absichtlich nicht speziell nachgespielt “wir haben sie nur in Details wiedergegeben und
                      versucht, die menschlichen Beziehungen in den Vordergrund zu stellen. Außerdem, für mich
                      die zentrale Figur in diesem Stück — nicht einmal Faryatiev, aber ein Teenager Lyuba, zu
                      dem die Mission von Faryatiev — alle zu vereinen. Denn nichts kann Luba brechen»
                    </blockquote>
                    <p />{' '}
                  </div>
                </div>
                ...
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      ...
                      <p></p>
                      <p>2 Stunden mit 1 Unterbrechung</p>
                      <p />
                    </div>
                  </div>
                </article>
