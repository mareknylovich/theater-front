      ...
      <main className="page-content">
                ...
                <div className="swiper-slide-caption text-center">
                  <div className="container">
                    ...
                    <div
                      ...
                      style={{ cursor: 'pointer' }}
                    >
                      <p>Worüber das Ballett schweigt, 18+</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row justify-content-xl-center row-50">
              <div className="col-xl-9">
                <h4 className="heading-decorated">Empfehlen</h4>
              </div>
            </div>
            <div className="row row-50">
                ...
                <div className="thumb thumb-corporate">
                  ...
                  <div className="thumb-corporate__caption">
                    <p className="thumb__title">
                      <a href="/schedule">Phantasien von Faryatyev</a>
                    </p>
                  </div>
                  <p className="auth-fonts">Alla Sokolova, Tragikomödie, 16+</p>
                  <br />
              ...
              <div className="col-md-3">
                <div className="thumb thumb-corporate">
                  ...
                  <div className="thumb-corporate__caption">
                    <p className="thumb__title">
                      <a href="/schedule">Zwei auf einer Schaukel</a>
                    </p>
                  </div>
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            <div className="row justify-content-xl-center row-50">
              <div className="col-xl-9">
                <h4 className="heading-decorated">Premieren</h4>
              </div>
            </div>
            <div className="row row-50">
              <div className="owl-carousel owl-theme2">
                <div className="item" style={{ marginRight: '15px' }}>
                  <div className="thumb thumb-corporate">
                    ...
                    <div className="thumb-corporate__caption">
                      <p className="thumb__title">
                        <a href="/schedule">Drei Kameraden</a>
                      </p>
                    </div>
                ...
                <div className="item" style={{ marginRight: '15px' }}>
                  <div className="thumb thumb-corporate">
                    ...
                    <div className="thumb-corporate__caption">
                      <p className="thumb__title">
                        <a href="/schedule">Verbrechen und Strafe</a>
                      </p>
                    </div>
              ...
              <div className="container">
                <div className="row justify-content-sm-center justify-content-lg-end row-30">
                  <div className="col-sm-10 col-md-7 col-lg-6 white-color">
                    <h3 className="white-color">Ihr Besuch</h3>
                    <p>
                      Alle nützlichen Informationen auf einer Seite: wie man Karten kauft und Geschenke
                      bekommt, wie man zum Theater kommt und wie man einen angenehmen Aufenthalt im Theater
                      hat.
                    </p>
