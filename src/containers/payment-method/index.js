  ...
  return (
    <Container>
      <Main>
        <Title>Buchung</Title>
        <Desk>
          Zum Zeitpunkt der Buchung ist 1 Euro auf Ihrem Konto reserviert. Der Restbetrag wird zum Zeitpunkt
          Ihres Besuchs bei uns bezahlt. Sie können Ihre Buchung jederzeit stornieren, ohne dass Ihnen Kosten
          ...
          <BbrBodyBank isOpen={d2}>
            <div>
              <div style={{ paddingLeft: 48, marginBottom: -24 }}>
                <LOADER />
                <strong>Verfügbare Banken</strong>
              </div>
              <BankCont>
                <P_N26>
              ...
              <div style={{ paddingLeft: 48, marginBottom: 24, marginTop: -24 }}>
                <strong>Haben Sie Ihre Bank nicht gefunden? Bezahlen Sie mit Karte.</strong>
              </div>
