...
export const PaymentCard = ({
  ...
  const { payment } = useSelector(({ paymentData: { data: dataPayment } }) => ({
    payment: dataPayment?.state,
  }));
  ...
  const { cardHolder = '', cardNumber = '', cardMonth = '', cardYear = '', cardCvv = '' } = data;
        ...
        <div className="card-item__wrapper">
          <div className="card-item__top">
            ...
            <div className="card-item__type">
              <img alt={useCardType} src={`/card-type/${useCardType}.png`} className="card-item__typeImg" />
            </div>
          </div>
...
PaymentCard.propTypes = {
  ...
  currentFocusedElm: PropTypes.node,
  onCardElementClick: PropTypes.func,
